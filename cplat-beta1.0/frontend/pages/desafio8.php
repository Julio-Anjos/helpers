...
<head>
<meta charset="UTF-8">
<title>Desafio 8: Painel de Temperaturas</title>
...
<p style="color: black">
Você foi contratado pela prefeitura para criar um mini-sistema que recebe as temperaturas registradas em 7 dias, com medições feitas de manhã e de tarde.<br><br>
<b>A prefeitura quer três coisas:</b><br>
<b>1.</b> A temperatura mais alta registrada na semana inteira.<br>
<b>2.</b> A temperatura mais baixa registrada na semana inteira.<br>
<b>3.</b> A temperatura média de cada período (manhã e tarde).<br>
E claro… querem isso num programa em C simples. Porque gastar com ferramentas de análise? Jamais.<br><br>

<b>Checklist de Implementação</b><br>
<b>1.</b> Uma matriz temperaturas<br>
&nbsp;&nbsp;&nbsp;&nbsp;<b>-</b> 7 linhas → cada dia da semana<br>
&nbsp;&nbsp;&nbsp;&nbsp;<b>-</b> 2 colunas → manhã e tarde<br>
<b>2.</b> Leitura das temperaturas<br>
&nbsp;&nbsp;&nbsp;&nbsp;<b>-</b> Use loops aninhados.<br>
&nbsp;&nbsp;&nbsp;&nbsp;<b>-</b> Peça ao usuário para digitar a temp. de cada dia e período.<br>
<b>3.</b> Encontrar o maior valor da matriz.<br>
<b>4.</b> Encontrar o menor valor da matriz.<br><br>
<b>5.</b> Calcular a média da manhã e a média da tarde separadamente.<br>
<b>6.</b> Exibir um relatório final com os dados solicitados pela prefeitura<br><br>

<b>Objetivo</b><br>
Ao final deste desafio, o programa deve ser capaz de declarar e manipular uma matriz bidimensional, receber entradas organizadas em linhas e colunas, percorrer seus elementos com laços aninhados e extrair informações úteis por meio de cálculos simples. O estudante deverá demonstrar domínio na leitura estruturada de dados, no acesso correto a índices de matrizes e na aplicação de operações como busca de máximos, mínimos e médias em um arranjo tabular.
</p>
...
<a href="modulo8.php" class="btn-nav">⟵ Voltar</a>
      </div>
...
fetch('../../backend/update_time.php', {
  ...
  body: JSON.stringify({ modulo_id: 8 })
});
...
### OBJETIVO
Avaliar o desafio "Relatório Climático Semanal". Nota: 0 a 100.

### REQUISITOS TÉCNICOS:
1. Declaração correta da matriz: 'float temperaturas[7][2]'.
2. Uso de laços aninhados (nested loops) para percorrer a matriz (um 'for' para dias, outro para períodos).
3. Lógica para encontrar o Maior e o Menor valor da matriz (inicialização correta das variáveis de busca).
4. Cálculo das médias separadas: uma para a coluna 0 (manhã) e outra para a coluna 1 (tarde).
5. Exibição organizada do relatório.

### TABELA DE PONTUAÇÃO (TOTAL: 100 PTS)
1. **Manipulação de Matriz (30 pts):** Declaração e acesso correto aos índices [i][j].
2. **Algoritmo de Busca (Máx/Mín) (30 pts):** Lógica correta para encontrar a maior e menor temperatura.
3. **Cálculo de Médias (25 pts):** Soma e divisão correta por 7 para cada período (coluna).
4. **Estrutura de Repetição (15 pts):** Uso eficiente de loops aninhados para leitura e processamento.
...
setInterval(() => {
  if (editor) {
    localStorage.setItem('codigo_desafio_8', editor.getValue());
  }
}, 2000);

require(['vs/editor/editor.main'], function () {
  const salvo = localStorage.getItem('codigo_desafio_8');
