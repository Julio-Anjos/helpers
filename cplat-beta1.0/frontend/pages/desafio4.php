...
<head>
<meta charset="UTF-8">
<title>Desafio 4: Conversor de Medidas</title>
...
<p style="color: black">
Uma empresa de logística está atualizando seu sistema interno e precisa de um pequeno programa que ajude os funcionários a converter rapidamente medidas entre diferentes unidades. A ideia é oferecer um menu simples, no qual o usuário escolhe qual conversão deseja fazer, informa o valor, e o programa devolve o resultado.<br><br>
<b>Opções disponíveis</b><br>
O menu deve apresentar as seguintes conversões numéricas:<br>
<b>1.</b> Metros → Centímetros<br>
<b>2.</b> Centímetros → Metros<br>
<b>3.</b> Quilômetros → Metros<br>
<b>4.</b> Metros → Quilômetros<br>
<b>5.</b> Sair do programa<br><br>

<b>O que o programa deve fazer</b><br>
<b>1.</b> Exibir o menu e pedir ao usuário que digite uma opção (1 a 5).<br>
<b>2.</b> Usar switch-case para selecionar a conversão desejada.<br>
<b>3.</b> Ler o valor a ser convertido somente após a escolha da opção.<br>
<b>4.</b> Realizar o cálculo correspondente e exibir o resultado.<br>
<b>5.</b> Caso a opção seja 5, apenas mostrar uma mensagem de saída.<br>
<b>6.</b> Caso o usuário digite uma opção inválida, exibir aviso apropriado.<br><br>

<b>Objetivo</b><br>
Ao final, o programa deve ser capaz de receber a escolha do usuário, realizar a conversão correspondente e imprimir o resultado corretamente, demonstrando domínio da seleção múltipla com switch-case, manipulação de valores numéricos e uso adequado de entrada/saída em C.
</p>
...
<a href="modulo4.php" class="btn-nav">⟵ Voltar</a>
      </div>
...
fetch('../../backend/update_time.php', {
  ...
  body: JSON.stringify({ modulo_id: 4 })
});
...
### OBJETIVO
Avaliar o desafio "Conversor de Medidas". Nota: 0 a 100.

### REQUISITOS TÉCNICOS:
1. Exibir um menu numerado de 1 a 5.
2. Uso obrigatório da estrutura 'switch-case' para processar a escolha do usuário.
3. Leitura do valor a ser convertido (float) somente após a escolha da opção no menu.
4. Presença do caso 'default' para tratar opções inválidas.
5. Lógica de conversão correta:
   - M -> CM (* 100) | CM -> M (/ 100)
   - KM -> M (* 1000) | M -> KM (/ 1000)

### TABELA DE PONTUAÇÃO (TOTAL: 100 PTS)
1. **Estrutura de Seleção (40 pts):** Uso correto do 'switch-case' com 'break' em cada caso. (Uso de IFs em vez de switch perde 20 pts).
2. **Lógica de Conversão (30 pts):** Operações matemáticas corretas para cada unidade.
3. **Menu e Interação (15 pts):** Leitura correta da opção e do valor (uso de & no scanf).
4. **Tratamento de Erros/Saída (15 pts):** Presença da opção 5 (Sair) e do caso 'default'.
...
setInterval(() => {
  if (editor) {
    localStorage.setItem('codigo_desafio_4', editor.getValue());
  }
}, 2000);

require(['vs/editor/editor.main'], function () {
  const salvo = localStorage.getItem('codigo_desafio_4');
  editor = monaco.editor.create(document.getElementById('editorContainer'), {
    value: salvo || "// Solução do Desafio 1 - Módulo 4\n",
    language: "c",
    theme: "vs-dark",
