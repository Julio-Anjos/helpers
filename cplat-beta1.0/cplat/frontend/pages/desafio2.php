...
<head>
<meta charset="UTF-8">
<title>Desafio 2: Calculadora de IMC</title>
...
<p style="color: black">
Você foi contratado por uma clínica que está digitalizando seus processos e precisa de uma ferramenta simples para auxiliar no atendimento inicial dos pacientes. A primeira demanda é criar um pequeno programa capaz de calcular o IMC (Índice de Massa Corporal) de uma pessoa com base em dados informados na hora.<br><br>
O programa deve fazer:<br>
<b>»</b> Pedir ao usuário que informe o seu peso (em kg).<br>
<b>»</b> Pedir ao usuário que informe a sua altura (em metros).<br>
<b>»</b> Armazenar esses valores em variáveis do tipo adequado.<br>
<b>»</b> Calcular o IMC usando operadores aritméticos e respeitando a precedência.<br>
<b>»</b> Exibir o resultado final com precisão decimal (ex.: 23.45).<br><br>

<b>Objetivo</b><br>
Ao final, o programa deve ser capaz de receber os dados de entrada, realizar o cálculo e imprimir o IMC corretamente, demonstrando domínio de variáveis, operadores aritméticos e entrada/saída de dados.
</p>
...
<a href="modulo2.php" class="btn-nav">⟵ Voltar</a>
      </div>



<script>
// Atualiza o tempo de estudo para o Módulo 2
fetch('../../backend/update_time.php', {
  method: 'POST',
  headers: {'Content-Type': 'application/json'},
  body: JSON.stringify({ modulo_id: 2 })
});
...
document.getElementById("codeForm").addEventListener("submit", async (e) => {
  ...
  // 1. Validação Prévia (Front-end) - Requisitos específicos do IMC
  const requisitos = ["stdio.h", "main", "scanf", "float"];
    ...
    while (status === "queued" || status === "processing") {
      ...
      if (status === "completed") {
                ...
                if (notaFinal >= 70) {
                    ...
                    outputDiv.innerHTML += `<br><br><b>✅ PRÉ-APROVADO! Enviado para revisão do professor.</b>`;
                } else {
                    outputDiv.style.color = "#ffab40";
                    outputDiv.innerHTML += `<br><br><b>⚠️ Nota insuficiente (${notaFinal}). Corrija e tente novamente.</b>`;
                    submitBtn.disabled = false;
                }

                // 3. Envio para o Banco (Módulo 2, Desafio 1)
...
// Salva o rascunho localmente para o desafio 2
setInterval(() => {
  if (editor) {
    localStorage.setItem('codigo_desafio_2', editor.getValue());
  }
}, 2000);

require(['vs/editor/editor.main'], function () {
  const salvo = localStorage.getItem('codigo_desafio_2');
